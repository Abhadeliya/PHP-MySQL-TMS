    ...
    <div class="page-container">
        <div class="left-content">
            ...
            <div style="width:100% display:flex;">
                <li
                    style="list-style: none; display: flex; float: right; padding: 10px; margin-top: 20px; border-radius: 6px; border: 2px solid white;">
                    <a href="../index.php" style="color:#fff"><i class="fa fa-sign-out"></i> Logout</a> </li>
            </div>
            <div class="agile-grids" style="margin-top:100px">
