...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql =
            'update TblTourPackages set PackageImage=:pimage where PackageId=:imgid';
    ...
    <div class="page-container">
        <div class="left-content">
            ...
            <div class="grid-form1">
                ...
                <?php if (
                  $error
              ) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } elseif (
                  $msg
