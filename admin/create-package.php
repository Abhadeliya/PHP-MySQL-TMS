...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        move_uploaded_file(
            ...
            'pacakgeimages/' . $_FILES['packageimage']['name']
        );
        $sql =
            'INSERT INTO tbltourpackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:pimage)';
        ...
        <div class="left-content">
            <div class="grid-form">
                <div class="grid-form1">
                    ...
                    <?php if (
                  $error
              ) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities(
    $error
); ?> </div><?php } elseif (
                  $msg
