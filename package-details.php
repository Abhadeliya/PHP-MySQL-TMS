    ...
    <div class="banner-3">
        <div class="container">
            <h1 class="wow zoomIn animated animated" data-wow-delay=".5s"
                style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;margin-top:40px">Package
                Details</h1>
        </div>
    </div>
                    ...
                    <div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
                        ...
                        <div class="ban-bottom">
                            <div class="bnr-right">
                                ...
                                <input class="date" autocomplete="off" id="datepicker" type="text"
                                    placeholder="dd-mm-yyyy" name="fromdate" required="">
                            </div>
                            <div class="bnr-right">
                                <label class="inputLabel">To</label>
                                <input class="date" autocomplete="off" id="datepicker1" type="text"
